...
import { Input, SettingItem, useGlobal, Dropdown } from "../refs";

const logger = debug("textgenerator:llmProvider:perplexityChat");
...
export default class LangchainPerplexityChatProvider
  extends LangchainBase
  implements LLMProviderInterface
{
  static provider = "Langchain" as const;
  static id = "Perplexity (Langchain)" as const;
  static slug = "perplexity" as const;
  static displayName = "Perplexity";

  streamable = true;

  id = LangchainPerplexityChatProvider.id;
  provider = LangchainPerplexityChatProvider.provider;
  originalId = LangchainPerplexityChatProvider.id;
    ...
    return (
      <>
        ...
        <div className="plug-tg-flex plug-tg-flex-col plug-tg-gap-2">
          ...
          <a href="https://docs.perplexity.ai">
            <SettingItem
